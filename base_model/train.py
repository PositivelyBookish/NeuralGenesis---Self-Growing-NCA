...
import os
sys.path.append("/home/Souvik.Roy/base_nca/")
...
def train(config):
    ...
    plot_loss(losses, "/home/Souvik.Roy/base_nca/models/lizard/L2/loss.png" )
...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--config", type=str, default="/home/Souvik.Roy/base_nca/train_config.yaml", help="Path to config file.")
